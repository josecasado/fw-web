...
def asavi():
    ...
    if response:
        ...
        writeMessage("\n" + "Se ha Insertando FW clase ORO (ASAv) perimetral en tenant  ->>" + t_name.value + " -- Tu Tenant asegurado con CISCO SECURITY" + "\n")
        return True
def asaphyg():
    excel()
    login()
    print "\n Insertando FW clase PLATINO (ASA_PHY) external en tenant: " + t_name.value + "\n"
...
def asaphyi():
    ...
    if response:
        ...
        writeMessage("\n" + "Se ha Insertando FW clase PLATINO (ASA_PHY) perimetral en tenant  ->>" + t_name.value + " -- Tu Tenant asegurado con CISCO SECURITY" + "\n")
        return True
...
def ftdv3i():
    ...
    if response:
        ...
        writeMessage("\n" + "Se ha Insertando FTD avanzado en tenant  ->>" + t_name.value + " -- Tu Tenant asegurado con CISCO SECURITY" + "\n")
        return True
...
def ftdv4i():
    ...
    if response:
        ...
        writeMessage("\n" + "Se ha Insertando FTD GESTIONADO protegiendo a la BD en tenant  ->>" + t_name.value + " -- Tu Tenant asegurado con CISCO SECURITY" + "\n")
        return True
